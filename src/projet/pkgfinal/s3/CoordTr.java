 ...
 * @author mouadabrini
 */
public class CoordTr extends javax.swing.JDialog {
    ...
    /**
     * Creates new form CoordTr
     */
    public CoordTr(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CoordTr.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                CoordTr dialog = new CoordTr(new javax.swing.JFrame(), true);
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Création d'un triangle");
        ...
        jLabel7.setText("Point 2");

        jLabel8.setText("ID 2 :");
        ...
        jLabel12.setText("ID3 :");

        jLabel13.setText("P3X :");

        jLabel14.setText("P3Y :");
    ...
    private void okActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_okActionPerformed
        ...
        P3X = Double.parseDouble(p3x.getText());
        P3Y = Double.parseDouble(p3y.getText());
        this.T = new Triangle(new Point(P1X, P1Y), new Point(P2X, P2Y), new Point(P3X, P3Y), ID);
        this.dispose();
